...
mod tests {
    ...
    const INPUT: [&str; 2] = [
        include_str!("../data/input21Test"),
        include_str!("../data/input21"),
    ];
    const EXPECTED_PART_ONE: [i64; 2] = [126384, 215374];
    const EXPECTED_PART_TWO: [i64; 2] = [154115708116294, 260586897262600];
